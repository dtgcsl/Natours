...
var displayMap = function displayMap(location) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZHRnY3NsIiwiYSI6ImNsYnRkcDVrdTF3NGkzcXBqZTczcHprOTUifQ.j7MSD0vCWsIPookXYMuc8Q';
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, req, res) {
    var stripe, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51MH2fZIKcWCtIDwm7rNcUDWNz6k1bvfs29OUMAKMNRJMyGCV9ruyxSZpNig7cCrzYzQritxzTxP9w4jj53Uvfhnc00ag1WlT8U');
            _context.prev = 1;
            _context.next = 4;
